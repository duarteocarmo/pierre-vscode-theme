...
M.light = {
  ...
  border = {
    window = M.gray["100"],
    editor = M.gray["200"],
    indent_guide = M.gray["100"],
    indent_guide_active = M.gray["200"],
    inset = M.gray["200"],
    elevated = M.gray["100"],
  },
  accent = {
  ...
  syntax = {
    ...
    func = M.indigo["500"],
    type = M.purple["500"],
    variable = M.orange["600"],
    operator = M.cyan["500"],
    punctuation = M.gray["700"],
    constant = M.yellow["600"],
    parameter = M.gray["700"],
    namespace = M.yellow["600"],
    decorator = M.blue["500"],
    escape = M.cyan["600"],
    invalid = "#ffffff",
    tag = M.red["600"],
    attribute = M.mint["600"],
  },
  ansi = {
    black = M.gray["980"],
    red = M.red["500"],
...
M.dark = {
  ...
  border = {
    ...
    indent_guide_active = M.gray["960"],
    inset = M.gray["920"],
    elevated = M.gray["960"],
  },
  accent = {
  ...
  syntax = {
    ...
    func = M.indigo["400"],
    type = M.purple["400"],
    variable = M.orange["400"],
    operator = M.cyan["500"],
    punctuation = M.gray["700"],
    constant = M.yellow["400"],
    parameter = M.gray["400"],
    namespace = M.yellow["500"],
    decorator = M.blue["400"],
    escape = M.cyan["400"],
    invalid = "#ffffff",
    tag = M.red["400"],
    attribute = M.mint["400"],
  },
  ansi = {
    black = M.gray["1000"],
    red = M.red["500"],
