...
function M.get(c)
  return {
    ...
    FloatBorder = { fg = c.border.editor, bg = c.bg.elevated },
    FloatTitle = { fg = c.fg.base, bg = c.bg.elevated, bold = true },
    Cursor = { fg = c.bg.editor, bg = c.accent.primary },
    CursorLine = { bg = c.accent.subtle },
    CursorLineNr = { fg = c.fg.fg2, bold = true },
