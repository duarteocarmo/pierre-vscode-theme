...
A Neovim colorscheme ported from the [Pierre VS Code theme](https://github.com/pierredotco/pierre-vscode-theme).
...
```lua
{
  "pierredotco/pierre-vscode-theme",
  name = "pierre",
  priority = 1000,
  config = function()
...
```vim
Plug 'pierredotco/pierre-vscode-theme'
